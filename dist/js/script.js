...
/* harmony import */ var _modules_postData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/postData */ "./src/js/modules/postData.js");
...
/* harmony import */ var _modules_parser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/parser */ "./src/js/modules/parser.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])('.btn_white', '.modal');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])('.btn_dark', '.modal');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_card__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_postData__WEBPACK_IMPORTED_MODULE_5__["default"])('.modal__content form');
  Object(_modules_postData__WEBPACK_IMPORTED_MODULE_5__["default"])('.order .container form');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_parser__WEBPACK_IMPORTED_MODULE_7__["default"])();
});
...
function calc() {
  ...
  hideAll();
  genderButtons[localStorage.getItem('wm2') || localStorage.getItem('wm')].classList.add('calculating__choose-item_active');
  hideConcret();
  btnsBig[localStorage.getItem('big2') || localStorage.getItem('big')].classList.add('calculating__choose-item_active');
}
...
function card() {
  ...
  postAllData('http://localhost:3000/menu').then(result => {
    result.forEach(({
      img,
      title,
      descr,
...
function postData(selector) {
  ...
  form.addEventListener('submit', function (e) {
    ...
    postAllData('http://localhost:3000/requests').then(result => {
...
function tabs() {
  let blocks = document.querySelectorAll('.tabcontent'),
      ...
      title = document.querySelectorAll('.tabheader__item'); //! active class = tabheader__item_active
